...
export const WEAPON_COLUMNS = [
  ...
  { key: 'effectiveBurstDps', label: 'DPS burst', fmt: 'num',
    def: 'Real DPS (Burst) — useful damage (total minus overkill) over firing time only.' },
  { key: 'effectiveSustainedDps', label: 'DPS sust', fmt: 'num',
    def: 'Real DPS (Sustained) — useful damage (total minus overkill) over firing + reload time.' },
  { key: 'effectiveCombatDps', label: 'DPS combat', fmt: 'num',
    def: 'Real DPS (In Combat) — useful damage (total minus overkill) over total time spent in combat.' },
