...
// equipment.js was removed (jumpJet/bubbleShield replaced by the hardcoded Sprint built-in,
// data/sprint.js). Every mountable item is a weapon now, so this is just a thin wrapper
