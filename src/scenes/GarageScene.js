...
export default class GarageScene extends Phaser.Scene {
  ...
  // ability/core slot outside of placement, or cancels an in-progress placement. START toggles
  // ready. This REPLACES the pre-#533 scheme, where d-pad left/right cycled colour directly and
  // A/X cycled a pre-selected tile's mount forward/back — colour is now one more row on the
  // merged chassis+color tab's own list (_activateListFocus), reached the same way any other row
  // is: navigate to it, press A.
  update(time, delta) {
    this._updateJoin();
