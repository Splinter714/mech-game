...
export { buildMechTextures, reskinMech, desaturateTexture, mechLayout, DESIGN, ART_SCALE, ARM_LOCATIONS, SHOULDER_LOCATIONS, PIVOT_LOCATIONS, PART_PIVOT, MUZZLE_GLOW_SUFFIX, HULL_FRAMES, PLAYER_HULL_FRAMES, strideDir, armSpriteTransform, partSpriteTransform } from './mechArt.js';
...
export { drawProjectileBody, HIGH_PROJECTILE_KINDS, drawBeam, drawSlash, drawGroundFire, projectileKind, itemFxKey, drawChargeWedge } from './projectileArt.js';
