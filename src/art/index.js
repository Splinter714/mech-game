...
export { buildMechTextures, reskinMech, mechLayout, DESIGN, ART_SCALE, ARM_LOCATIONS, SIDE_TORSO_LOCATIONS, PIVOT_LOCATIONS, PART_PIVOT, MUZZLE_GLOW_SUFFIX, armSpriteTransform, partSpriteTransform } from './mechArt.js';
// Non-mech unit textures (turret / wall turret / tank / drone / helicopter / carrier /
// infantry), built per-unit on spawn.
