...
export function draw(g, x, y, ca, sa, color, s, phase) {
  ...
  // #546 (art dissect tool): three parts — the wake/corona trailing the glob, the teardrop body
  // itself (rim + front + tail + highlight), and the shed droplets wobbling off it.
  g.layer?.('wake');
