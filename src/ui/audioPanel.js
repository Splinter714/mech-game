...
const GROUPS = [
  ...
  ['Rhythm guitar (the chug)', [
    ...
    ['guitarTone', 'Low-pass (Hz)', 1500, 9000, 50],
    ['guitarLowCut', 'High-pass (Hz)', 40, 400, 5],
    ...
    ['chugLength', 'Note length', 0.03, 0.2, 0.005],
  ]],
  ['Lead 1 (saw)', [
    ...
    ['leadTone', 'Low-pass (Hz)', 400, 16000, 50],
    ['leadLowCut', 'High-pass (Hz)', 40, 400, 5],
  ...
  ['Lead 2 (square)', [
    ...
    ['lead2Tone', 'Low-pass (Hz)', 400, 16000, 50],
    ['lead2LowCut', 'High-pass (Hz)', 40, 400, 5],
